# Clear Browser Cache
# Clears browser cache for all users. Supports Google Chrome, Mozilla Firefox and Microsoft Internet Explorer.
# Note: This script requires Windows Vista+ / Windows Server 2008+.
